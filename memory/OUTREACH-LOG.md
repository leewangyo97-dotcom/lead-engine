...
|---|---|---|---|---|---|---|
| 2026-09-02 | This Dot Labs | Senior Android Engineer (Kotlin), Senior React Native Engineer, Senior JavaScript Engineer, Software Architect | stack-exact | crash-rate; shipped-apps | not sent |  |
| 2026-09-24 | CyberAtlas | Software Engineer | paid-trial | defects | not sent — verified, awaiting Gmail token | First draft failed verifier: "Backend engineer" title and "seven years" pinned to the backend stack, neither in PROFILE. Revision passed |
| 2026-09-24 | Atria | Engineering roles — follow-up 1 | paid-trial | fastlane | not sent — verified, awaiting Gmail token | Day-4 nudge, ten days late |
| 2026-09-24 | This Dot Labs | follow-up 1 | bench-offer | kmp | not sent — verified, awaiting Gmail token | Day-4 nudge, ten days late |
